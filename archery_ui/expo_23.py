...
text_box_rect = pygame.Rect(
    text_box_pos, (text_box_width, text_box_height))
input_text = ""
...
# #  dimension
# text = "Score card :"
# scr_surface = font.render(text, True, (0, 0, 0))
# scr_pos = (1250, 120)
# screen.blit(scr_surface, scr_pos)

# score_size = (400, 800)
# score_surf = pygame.Surface(score_size)  # create a surface
# score_surf.fill((234, 213, 211))  # fill color
# surf_pos = (1250, 150)  # start pos on screen
